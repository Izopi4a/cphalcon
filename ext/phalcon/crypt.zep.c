...
PHP_METHOD(Phalcon_Crypt, _cryptPadText) {
	...
	if (_0) {
		...
		do {
			if (paddingType == 1) {
				ZVAL_LONG(&_1$$5, 0);
				ZEPHIR_CALL_FUNCTION(&_2$$5, "chr", &_3, 126, &_1$$5);
				zephir_check_call_status();
				ZVAL_LONG(&_1$$5, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_4$$5, "str_repeat", &_5, 127, &_2$$5, &_1$$5);
				zephir_check_call_status();
				ZVAL_LONG(&_1$$5, paddingSize);
				ZEPHIR_CALL_FUNCTION(&_6$$5, "chr", &_3, 126, &_1$$5);
				zephir_check_call_status();
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_8$$6, "chr", &_3, 126, &_7$$6);
				zephir_check_call_status();
				ZVAL_LONG(&_7$$6, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 127, &_8$$6, &_7$$6);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 3) {
				...
				if (_10$$7 <= _11$$7) {
					while (1) {
						...
						i = _10$$7;
						ZEPHIR_CALL_FUNCTION(&_12$$8, "rand", &_13, 104);
						zephir_check_call_status();
						ZEPHIR_CALL_FUNCTION(&_14$$8, "chr", &_3, 126, &_12$$8);
						zephir_check_call_status();
						zephir_concat_self(&padding, &_14$$8 TSRMLS_CC);
					}
				}
				ZVAL_LONG(&_15$$7, paddingSize);
				ZEPHIR_CALL_FUNCTION(&_16$$7, "chr", &_3, 126, &_15$$7);
				zephir_check_call_status();
			...
			if (paddingType == 4) {
				...
				ZEPHIR_CALL_FUNCTION(&_18$$9, "chr", &_3, 126, &_17$$9);
				zephir_check_call_status();
				ZVAL_LONG(&_17$$9, 0);
				ZEPHIR_CALL_FUNCTION(&_19$$9, "chr", &_3, 126, &_17$$9);
				zephir_check_call_status();
				ZVAL_LONG(&_17$$9, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_20$$9, "str_repeat", &_5, 127, &_19$$9, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&padding);
			...
			if (paddingType == 5) {
				ZVAL_LONG(&_21$$10, 0);
				ZEPHIR_CALL_FUNCTION(&_22$$10, "chr", &_3, 126, &_21$$10);
				zephir_check_call_status();
				ZVAL_LONG(&_21$$10, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 127, &_22$$10, &_21$$10);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 6) {
				...
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 127, &_23$$11, &_24$$11);
				zephir_check_call_status();
				break;
			}
			paddingSize = 0;
	...
	if (_1) {
		do {
			if (paddingType == 1) {
				...
				ZEPHIR_CALL_FUNCTION(&_5$$4, "ord", &_6, 128, &last);
				zephir_check_call_status();
				ord = zephir_get_intval(&_5$$4);
				if (ord <= blockSize) {
					paddingSize = ord;
					ZVAL_LONG(&_7$$5, 0);
					ZEPHIR_CALL_FUNCTION(&_8$$5, "chr", &_9, 126, &_7$$5);
					zephir_check_call_status();
					ZVAL_LONG(&_7$$5, (paddingSize - 1));
					ZEPHIR_CALL_FUNCTION(&_10$$5, "str_repeat", &_11, 127, &_8$$5, &_7$$5);
					zephir_check_call_status();
					ZEPHIR_INIT_VAR(&padding);
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_15$$7, "ord", &_6, 128, &last);
				zephir_check_call_status();
				ord = zephir_get_intval(&_15$$7);
				if (ord <= blockSize) {
					paddingSize = ord;
					ZVAL_LONG(&_16$$8, paddingSize);
					ZEPHIR_CALL_FUNCTION(&_17$$8, "chr", &_9, 126, &_16$$8);
					zephir_check_call_status();
					ZVAL_LONG(&_16$$8, paddingSize);
					ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_11, 127, &_17$$8, &_16$$8);
					zephir_check_call_status();
			...
			if (paddingType == 3) {
				...
				ZEPHIR_CALL_FUNCTION(&_21$$10, "ord", &_6, 128, &last);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, encrypt) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "openssl_get_cipher_methods", NULL, 130, &__$true);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&ivSize, "openssl_cipher_iv_length", &_4, 131, &cipher);
	zephir_check_call_status();
	if (ZEPHIR_GT_LONG(&ivSize, 0)) {
		...
		ZVAL_STRING(&_6$$9, "");
		ZEPHIR_CALL_FUNCTION(&_7$$9, "str_ireplace", NULL, 132, &_5$$9, &_6$$9, &cipher);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&blockSize, "openssl_cipher_iv_length", &_4, 131, &_7$$9);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(&iv, "openssl_random_pseudo_bytes", NULL, 133, &ivSize);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_10, 1);
	ZEPHIR_CALL_FUNCTION(&_11, "openssl_encrypt", NULL, 134, &padded, &cipher, &encryptKey, &_10, &iv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, decrypt) {
	...
	ZVAL_LONG(&_11, 1);
	ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 135, &_8, &cipher, &decryptKey, &_11, &_10);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&paddingType);
	zephir_read_property(&paddingType, this_ptr, SL("_padding"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Crypt, encryptBase64) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zend_bool safe;
	zval *text_param = NULL, *key = NULL, key_sub, *safe_param = NULL, __$null, _0$$3, _2$$3, _4$$3, _5$$3, _6;
	zval text;
	ZEPHIR_INIT_THIS();
	...
	if (unlikely(Z_TYPE_P(safe_param) != IS_TRUE && Z_TYPE_P(safe_param) != IS_FALSE)) {
	...
	if (safe == 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_2$$3, "base64_encode", &_3, 109, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "+/");
		ZEPHIR_INIT_VAR(&_5$$3);
		ZVAL_STRING(&_5$$3, "-_");
		ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 21, &_2$$3, &_4$$3, &_5$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "encrypt", &_1, 0, &text, key);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", &_3, 109, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Crypt, decryptBase64) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zend_bool safe;
	zval *text_param = NULL, *key = NULL, key_sub, *safe_param = NULL, __$null, _0$$3, _1$$3, _2$$3, _3$$3, _6;
	zval text;
	ZEPHIR_INIT_THIS();
	...
	if (safe == 1) {
		...
		ZVAL_STRING(&_1$$3, "+/");
		ZEPHIR_CALL_FUNCTION(&_2$$3, "strtr", NULL, 21, &text, &_0$$3, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_3$$3, "base64_decode", &_4, 110, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "decrypt", &_5, 0, &_3$$3, key);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_6, "base64_decode", &_4, 110, &text);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, getAvailableCiphers) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_get_cipher_methods", NULL, 130, &__$true);
	zephir_check_call_status();
	RETURN_MM();
