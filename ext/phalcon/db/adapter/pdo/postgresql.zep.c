...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, connect) {
	...
	ZEPHIR_CALL_PARENT(&status, phalcon_db_adapter_pdo_postgresql_ce, this_ptr, "connect", &_5, 0, &descriptor);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, describeColumns) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
	{
		...
		if (Z_TYPE_P(&_34$$3) != IS_NULL) {
			...
			ZVAL_STRING(&_37$$26, "");
			ZEPHIR_CALL_FUNCTION(&_38$$26, "preg_replace", &_39, 33, &_36$$26, &_37$$26, &_35$$26);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_41$$26, "strcasecmp", &_42, 11, &_40$$26, &_36$$26);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &_43$$3, "__construct", &_44, 136, &columnName, &definition);
		zephir_check_call_status();
