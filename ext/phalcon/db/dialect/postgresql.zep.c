		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _9$$37)
				{
					...
					ZVAL_STRING(&_10$$38, "\\'");
					ZEPHIR_CALL_FUNCTION(&_11$$38, "addcslashes", &_12, 137, &value$$37, &_10$$38);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_18$$39, "\\'");
				ZEPHIR_CALL_FUNCTION(&_19$$39, "addcslashes", &_12, 137, &typeValues, &_18$$39);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, addIndex) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getcolumnlist", NULL, 48, &_6);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_7);
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, createTable) {
	...
	if (!(ZEPHIR_IS_EMPTY(&primaryColumns))) {
		ZEPHIR_CALL_METHOD(&_11$$13, this_ptr, "getcolumnlist", NULL, 48, &primaryColumns);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&indexes, &definition, SL("indexes"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _13$$14)
		{
			...
			if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_14$$16, this_ptr, "getcolumnlist", NULL, 48, &_15$$16);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&indexSql);
				...
				if (!(ZEPHIR_IS_EMPTY(&indexType))) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_16$$18, this_ptr, "getcolumnlist", NULL, 48, &_17$$18);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&indexSql);
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_21$$19, this_ptr, "getcolumnlist", NULL, 48, &_22$$19);
					zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _24$$21)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_26$$22, this_ptr, "getcolumnlist", NULL, 48, &_27$$22);
			zephir_check_call_status();
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_30$$22, this_ptr, "getcolumnlist", NULL, 48, &_31$$22);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, createView) {
	...
	if (!(zephir_array_isset_string_fetch(&viewSql, &definition, SL("sql"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "The index 'sql' is required in the definition array", "phalcon/db/dialect/postgresql.zep", 514);
		return;
	}
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, _castDefault) {
	...
	if (zephir_memnstr_str(&_0, SL("BOOLEAN"), "phalcon/db/dialect/postgresql.zep", 654)) {
	...
	if (zephir_memnstr_str(&_2, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/postgresql.zep", 658)) {
	...
	if (_6) {
		...
		ZVAL_STRING(&_8$$6, "\\'");
		ZEPHIR_CALL_FUNCTION(&_9$$6, "addcslashes", NULL, 137, &defaultValue, &_8$$6);
		zephir_check_call_status();
