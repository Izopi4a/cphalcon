		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _12$$41)
				{
					...
					ZVAL_STRING(&_13$$42, "\"");
					ZEPHIR_CALL_FUNCTION(&_14$$42, "addcslashes", &_15, 137, &value$$41, &_13$$42);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_21$$43, "\"");
				ZEPHIR_CALL_FUNCTION(&_22$$43, "addcslashes", &_15, 137, &typeValues, &_21$$43);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addColumn) {
	...
	if (zephir_is_true(&_4)) {
		...
		if (zephir_memnstr_str(&_5$$3, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 203)) {
			...
			ZVAL_STRING(&_6$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_7$$5, "addcslashes", NULL, 137, &defaultValue, &_6$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addIndex) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "getcolumnlist", NULL, 48, &_5);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, createTable) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
	{
		...
		if (zephir_is_true(&_8$$7)) {
			...
			if (zephir_memnstr_str(&_9$$10, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 360)) {
				...
				ZVAL_STRING(&_10$$12, "\"");
				ZEPHIR_CALL_FUNCTION(&_11$$12, "addcslashes", &_12, 137, &defaultValue, &_10$$12);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&indexes, &definition, SL("indexes"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _15$$14)
		{
			...
			if (_16$$15) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_19$$16, this_ptr, "getcolumnlist", &_21, 48, &_20$$16);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_23$$17, this_ptr, "getcolumnlist", &_21, 48, &_24$$17);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _26$$18)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_28$$19, this_ptr, "getcolumnlist", &_21, 48, &_29$$19);
			zephir_check_call_status();
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_31$$19, this_ptr, "getcolumnlist", &_21, 48, &_32$$19);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, listIndexesSql) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "escape", NULL, 47, &table);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	...
	if (!(Z_TYPE_P(&keyName) == IS_UNDEF) && Z_STRLEN_P(&keyName)) {
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "escape", NULL, 47, &keyName);
		zephir_check_call_status();
