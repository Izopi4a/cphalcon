...
PHP_METHOD(Phalcon_Debug, listenExceptions) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 142, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, listenLowSeverity) {
	...
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 143, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 142, &_2);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, debugVar) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "debug_backtrace", NULL, 144);
	zephir_check_call_status();
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_INIT_VAR(&_2);
	zephir_time(&_2);
...
PHP_METHOD(Phalcon_Debug, _escapeString) {
	...
	if (Z_TYPE_P(value) == IS_STRING) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("htmlentities", NULL, 145, &_0$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Debug, _getArrayDump) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&argument), _2, _3, _1)
	{
		...
		if (ZEPHIR_IS_STRING(&v, "")) {
			...
			ZEPHIR_CALL_METHOD(&_5$$8, this_ptr, "_getarraydump", &_7, 146, &v, &_6$$8);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&varDump);
...
PHP_METHOD(Phalcon_Debug, _getVarDump) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&_2$$11, this_ptr, "_getarraydump", &_1, 146, variable);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, showTraceItem) {
	...
	if (zephir_array_isset_string_fetch(&className, &trace, SL("class"), 0)) {
		...
		if (zephir_is_true(&_3$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &classReflection, "__construct", NULL, 83, &className);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_7$$5, &classReflection, "isinternal", NULL, 147);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string(&trace, SL("class"))) {
		...
		if ((zephir_function_exists(&functionName TSRMLS_CC)  == SUCCESS)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &functionReflection, "__construct", NULL, 74, &functionName);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_13$$10, &functionReflection, "isinternal", NULL, 148);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&traceArgs, &trace, SL("args"), 0)) {
		...
		zephir_is_iterable(&traceArgs, 0, "phalcon/debug.zep", 441);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&traceArgs), _17$$14)
		{
			...
			zephir_array_append(&arguments, &_20$$15, PH_SEPARATE, "phalcon/debug.zep", 435);
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&argument);
	...
	if (zephir_array_isset_string_fetch(&filez, &trace, SL("file"), 0)) {
		...
		zephir_array_fetch_string(&_23$$16, &trace, SL("line"), PH_NOISY, "phalcon/debug.zep", 449 TSRMLS_CC);
		...
		if (zephir_is_true(&showFiles)) {
			ZEPHIR_CALL_FUNCTION(&lines, "file", NULL, 149, &filez);
			zephir_check_call_status();
			...
			while (1) {
				...
				if (_38$$24) {
					...
					ZEPHIR_CALL_FUNCTION(&_44$$29, "htmlentities", &_45, 145, &_39$$29, &_42$$29, &_43$$29);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, onUncaughtLowSeverity) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "error_reporting", NULL, 150);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_1);
	...
	if (zephir_is_true(&_1)) {
		...
		ZVAL_LONG(&_3$$3, 0);
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 151, message, &_3$$3, severity, file, line);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, onUncaughtException) {
	...
	ZEPHIR_CALL_FUNCTION(&obLevel, "ob_get_level", NULL, 152);
	zephir_check_call_status();
	if (ZEPHIR_GT_LONG(&obLevel, 0)) {
		ZEPHIR_CALL_FUNCTION(NULL, "ob_end_clean", NULL, 117);
		zephir_check_call_status();
	}
	...
	if (zephir_is_true(&showBackTrace)) {
		...
		zephir_check_call_status();
		zephir_is_iterable(&_10$$5, 0, "phalcon/debug.zep", 659);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_10$$5), _12$$5, _13$$5, _11$$5)
		{
			...
			ZEPHIR_CALL_METHOD(&_14$$7, this_ptr, "showtraceitem", &_15, 153, &n, &traceItem);
			zephir_check_call_status();
		...
		zephir_is_iterable(&_REQUEST, 0, "phalcon/debug.zep", 673);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_REQUEST), _17$$5, _18$$5, _16$$5)
		{
			...
			if (Z_TYPE_P(&value) != IS_ARRAY) {
				...
				ZEPHIR_CALL_FUNCTION(&_20$$10, "print_r", &_21, 154, &value, &__$true);
				zephir_check_call_status();
		...
		zephir_concat_self_str(&html, SL("<tr><th>Key</th><th>Value</th></tr>") TSRMLS_CC);
		zephir_is_iterable(&_SERVER, 0, "phalcon/debug.zep", 683);
		...
		ZEPHIR_CALL_FUNCTION(&_29$$5, "get_included_files", NULL, 155);
		zephir_check_call_status();
		zephir_is_iterable(&_29$$5, 0, "phalcon/debug.zep", 693);
		...
		ZEPHIR_CALL_FUNCTION(&_34$$5, "memory_get_usage", NULL, 156, &__$true);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&dataVars) == IS_ARRAY) {
			...
			zephir_concat_self_str(&html, SL("<tr><th>Key</th><th>Value</th></tr>") TSRMLS_CC);
			zephir_is_iterable(&dataVars, 0, "phalcon/debug.zep", 711);
