...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$4, "strtr", &_5, 21, &_3$$4, &_1$$4);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _7$$4, _8$$4, _6$$4)
		{
			...
			ZVAL_LONG(&_9$$5, tab);
			ZEPHIR_CALL_FUNCTION(&_10$$5, "str_repeat", &_11, 127, &space, &_9$$5);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_13$$5, "strtr", &_5, 21, &_14$$5, &_12$$5);
			zephir_check_call_status();
			...
			if (_18$$5) {
				...
				ZEPHIR_CALL_METHOD(&_19$$7, this_ptr, "output", &_22, 157, &value, &_20$$7, &_21$$7);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_25$$4, "str_repeat", &_11, 127, &space, &_24$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_27$$8, "strtr", &_5, 21, &_28$$8, &_26$$8);
		zephir_check_call_status();
		zephir_concat_self(&output, &_27$$8 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_29$$8, "get_parent_class", &_30, 158, variable);
		zephir_check_call_status();
		if (zephir_is_true(&_29$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_32$$9, "get_parent_class", &_30, 158, variable);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_32$$9, "strtr", &_5, 21, &_33$$9, &_31$$9);
			zephir_check_call_status();
		...
		if (zephir_instance_of_ev(variable, phalcon_di_ce TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_36$$10, "str_repeat", &_11, 127, &space, &_35$$10);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_38$$11, "get_object_vars", NULL, 16, variable);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_38$$11), _40$$11, _41$$11, _39$$11)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_43$$12, "str_repeat", &_11, 127, &space, &_42$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_45$$12, "strtr", &_5, 21, &_46$$12, &_44$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_48$$12, this_ptr, "output", &_22, 157, &value, &_46$$12, &_42$$12);
				zephir_check_call_status();
			...
			do {
				...
				ZEPHIR_CALL_FUNCTION(&attr, "each", &_50, 159, variable);
				...
				ZVAL_LONG(&_52$$14, 0);
				ZEPHIR_CALL_FUNCTION(&_53$$14, "chr", &_54, 126, &_52$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_56$$14, "str_repeat", &_11, 127, &space, &_52$$14);
				zephir_check_call_status();
				...
				ZEPHIR_MAKE_REF(&key);
				ZEPHIR_CALL_FUNCTION(&_58$$14, "end", &_59, 160, &key);
				ZEPHIR_UNREF(&key);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_58$$14, "strtr", &_5, 21, &_51$$14, &_57$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_61$$14, this_ptr, "output", &_22, 157, &value, &_51$$14, &_52$$14);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&attr, "get_class_methods", NULL, 161, variable);
		zephir_check_call_status();
		ZVAL_LONG(&_63$$8, tab);
		ZEPHIR_CALL_FUNCTION(&_64$$8, "str_repeat", &_11, 127, &space, &_63$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_66$$8, "strtr", &_5, 21, &_28$$8, &_65$$8);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(&_28$$8, &_63$$8 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_69$$19, "str_repeat", &_11, 127, &space, &_68$$19);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _71$$20)
			{
				...
				if (ZEPHIR_IS_STRING(&value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_74$$22, "str_repeat", &_11, 127, &space, &_73$$22);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_76$$22, "strtr", &_5, 21, &_77$$22, &_75$$22);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_80$$23, "str_repeat", &_11, 127, &space, &_79$$23);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_82$$23, "strtr", &_5, 21, &_83$$23, &_81$$23);
					zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_86$$20, "str_repeat", &_11, 127, &space, &_85$$20);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_89$$8, "str_repeat", &_11, 127, &space, &_88$$8);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_91$$24, "strtr", &_5, 21, &_92$$24, &_90$$24);
		zephir_check_call_status();
		ZEPHIR_CONCAT_VV(return_value, &output, &_91$$24);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_93, "is_float", NULL, 162, variable);
	zephir_check_call_status();
	if (zephir_is_true(&_93)) {
		...
		ZEPHIR_CALL_FUNCTION(&_95$$25, "strtr", &_5, 21, &_96$$25, &_94$$25);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_98$$26, "strtr", &_5, 21, &_99$$26, &_97$$26);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_101$$27, "htmlentities", NULL, 145, variable, &_103$$27, &_102$$27);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_104$$27, "nl2br", NULL, 163, &_101$$27);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_104$$27, "strtr", &_5, 21, &_102$$27, &_100$$27);
		zephir_check_call_status();
	...
	if ((Z_TYPE_P(variable) == IS_TRUE || Z_TYPE_P(variable) == IS_FALSE)) {
		...
		ZEPHIR_CALL_FUNCTION(&_106$$28, "strtr", &_5, 21, &_107$$28, &_105$$28);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_110$$29, "strtr", &_5, 21, &_111$$29, &_109$$29);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_113, "strtr", &_5, 21, &_114, &_112);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug_Dump, variable) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("strtr", NULL, 21, &_2, &_0);
	zephir_check_call_status();
	RETURN_MM();
