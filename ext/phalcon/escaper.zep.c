...
PHP_METHOD(Phalcon_Escaper, detectEncoding) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _2)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_3$$5, "mb_detect_encoding", &_4, 167, &str, &charset, &__$true);
	...
	ZEPHIR_INIT_NVAR(&charset);
	ZEPHIR_RETURN_CALL_FUNCTION("mb_detect_encoding", &_4, 167, &str);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, normalizeEncoding) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "detectencoding", NULL, 168, &str);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "UTF-32");
	ZEPHIR_RETURN_CALL_FUNCTION("mb_convert_encoding", NULL, 169, &str, &_1, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, escapeHtml) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 170, &text, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, escapeHtmlAttr) {
	...
	ZVAL_LONG(&_2, 3);
	ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 170, &attribute, &_2, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Escaper, escapeCss) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeencoding", NULL, 171, &css);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Escaper, escapeJs) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeencoding", NULL, 171, &js);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Escaper, escapeUrl) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 172, &url);
	zephir_check_call_status();
	RETURN_MM();
