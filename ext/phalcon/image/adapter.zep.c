...
PHP_METHOD(Phalcon_Image_Adapter, resize) {
	...
	ZVAL_LONG(&_25, 1);
	ZEPHIR_CALL_FUNCTION(&_26, "max", &_27, 64, &_23, &_25);
	...
	ZVAL_LONG(&_29, 1);
	ZEPHIR_CALL_FUNCTION(&_30, "max", &_27, 64, &_28, &_29);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, text) {
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$7, "preg_replace", NULL, 33, &_6$$7, &_7$$7, &color);
		zephir_check_call_status();
		zephir_get_strval(&color, &_8$$7);
	}
	ZVAL_LONG(&_9, 2);
	ZEPHIR_CALL_FUNCTION(&_10, "str_split", NULL, 65, &color, &_9);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_11);
...
PHP_METHOD(Phalcon_Image_Adapter, background) {
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$4, "preg_replace", NULL, 33, &_6$$4, &_7$$4, &color);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, render) {
	...
	if (!(!(Z_TYPE_P(&ext) == IS_UNDEF) && Z_STRLEN_P(&ext))) {
		...
		ZVAL_LONG(&_1$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "pathinfo", NULL, 67, &_0$$3, &_1$$3);
		zephir_check_call_status();
