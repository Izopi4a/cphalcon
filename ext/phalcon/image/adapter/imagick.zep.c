...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 207, &_2);
	zephir_check_call_status();
	if (zephir_is_true(&_3)) {
		ZEPHIR_INIT_VAR(&_4$$5);
		ZVAL_STRING(&_4$$5, "Imagick::IMAGICK_EXTNUM");
		ZEPHIR_CALL_FUNCTION(&_5$$5, "constant", NULL, 179, &_4$$5);
		zephir_check_call_status();
		zephir_update_static_property_ce(phalcon_image_adapter_imagick_ce, SL("_version"), &_5$$5);
	}
	zephir_update_static_property_ce(phalcon_image_adapter_imagick_ce, SL("_checked"), &__$true);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct) {
	...
	if ((zephir_file_exists(&_2 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$4, "realpath", NULL, 58, &_3$$4);
		zephir_check_call_status();
		...
		if (!(zephir_is_true(&_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 179, &_14$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 179, &_19$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_22$$7, 0);
		ZVAL_LONG(&_23$$7, 0);
		...
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 179, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 179, &_19$$7);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 179, &_36$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_45$$10, "constant", &_21, 179, &_36$$10);
		zephir_check_call_status();
		ZVAL_LONG(&_46$$10, 0);
		ZVAL_LONG(&_47$$10, 0);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_51$$13, "constant", &_21, 179, &_50$$13);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark) {
	...
	if (likely((zephir_method_exists_ex(&watermark, SL("getversion") TSRMLS_CC) == SUCCESS))) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$5, "constant", &_7, 179, &_5$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _text) {
	...
	int opacity, r, g, b, size, ZEPHIR_LAST_CALL_STATUS, x = 0, y = 0;
	...
	ZVAL_LONG(&_2, g);
	ZVAL_LONG(&_3, b);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 176, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
			...
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_12$$17);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_13$$18);
						ZVAL_STRING(&_13$$18, "Imagick::GRAVITY_NORTHEAST");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_13$$18);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_14$$20);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_15$$21);
						ZVAL_STRING(&_15$$21, "Imagick::GRAVITY_NORTH");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_15$$21);
						zephir_check_call_status();
					}
				}
			}
				...
				if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_16$$27);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_17$$28);
							ZVAL_STRING(&_17$$28, "Imagick::GRAVITY_SOUTH");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_17$$28);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_18$$30);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_19$$31);
							ZVAL_STRING(&_19$$31, "Imagick::GRAVITY_WEST");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_19$$31);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_20$$35);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_INIT_VAR(&_21$$36);
								ZVAL_STRING(&_21$$36, "Imagick::GRAVITY_NORTHEAST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_21$$36);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_22$$38);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_INIT_VAR(&_23$$39);
								ZVAL_STRING(&_23$$39, "Imagick::GRAVITY_NORTHWEST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_8, 179, &_23$$39);
								zephir_check_call_status();
							}
						}
					}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "constant", &_7, 179, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$3, 0);
		ZVAL_LONG(&_9$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background) {
	...
	while (1) {
		...
		if (!(zephir_is_true(&_7$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$4, "constant", &_11, 179, &_9$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15$$3, "constant", &_11, 179, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_16$$3, "constant", &_11, 179, &_14$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_22$$3, "constant", &_11, 179, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_23$$3, 0);
		ZVAL_LONG(&_24$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _pixelate) {
	...
	int amount, ZEPHIR_LAST_CALL_STATUS, width = 0, height = 0;
	ZEPHIR_INIT_THIS();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save) {
	...
	if (ZEPHIR_IS_LONG(&_8, 0)) {
		...
		ZVAL_STRING(&_11$$3, "w");
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 228, &file, &_11$$3);
		zephir_check_call_status();
		...
		if (_15$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_19$$5, "constant", NULL, 179, &_18$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render) {
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_4, 0)) {
		...
		if (_8$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_11$$5, "constant", NULL, 179, &_10$$5);
			zephir_check_call_status();
