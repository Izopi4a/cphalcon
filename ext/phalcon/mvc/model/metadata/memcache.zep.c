...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 266, &_6);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 268, &_5, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, reset) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_memcache_ce, this_ptr, "reset", &_5, 0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
