...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, addFrom) {
	...
	zval *model, model_sub, *alias = NULL, alias_sub, *with = NULL, with_sub, __$null, models, currentModel;
	ZEPHIR_INIT_THIS();
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, betweenWhere) {
	...
	zend_bool _0;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *expr_param = NULL, *minimum, minimum_sub, *maximum, maximum_sub, *operator_param = NULL, hiddenParam, nextHiddenParam, minimumKey, maximumKey, operatorMethod, _5, _1$$3, _2$$3, _3$$3;
	zval expr, operator, _4;
	ZEPHIR_INIT_THIS();
	...
	if (_0) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$3, "sprintf", NULL, 176, &_2$$3, &operator);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 4, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/mvc/model/query/builder.zep", 689 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
	ZEPHIR_CONCAT_VS(&_4, &operator, "Where");
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, notBetweenWhere) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 4, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/mvc/model/query/builder.zep", 732 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, inWhere) {
	...
	zval values;
	zval *expr_param = NULL, *values_param = NULL, *operator_param = NULL, key, queryKey, value, bindKeys, bindParams, operatorMethod, _6, *_7, _10, _11, _12, _1$$3, _2$$3, _3$$3, _8$$5;
	zval expr, operator, _4, _5$$4, _9$$5;
	ZEPHIR_INIT_THIS();
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 4, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/mvc/model/query/builder.zep", 775 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
	...
	array_init(&bindKeys);
	zephir_is_iterable(&values, 0, "phalcon/mvc/model/query/builder.zep", 804);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&values), _7)
	{
		...
		zephir_array_append(&bindKeys, &queryKey, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 795);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, notInWhere) {
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 4, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/mvc/model/query/builder.zep", 824 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
	...
	ZEPHIR_INIT_VAR(&bindKeys);
	array_init(&bindKeys);
	zephir_is_iterable(&values, 0, "phalcon/mvc/model/query/builder.zep", 853);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&values), _7)
	{
		ZEPHIR_INIT_NVAR(&value);
		ZVAL_COPY(&value, _7);
		...
		ZEPHIR_INIT_NVAR(&queryKey);
		ZEPHIR_CONCAT_SVS(&queryKey, ":", &key, ":");
		zephir_array_append(&bindKeys, &queryKey, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 844);
		zephir_array_update_zval(&bindParams, &key, &value, PH_COPY | PH_SEPARATE);
		hiddenParam++;
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&value);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, having) {
	...
	zephir_update_property_zval(this_ptr, SL("_having"), &having);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, limit) {
	...
	ZVAL_LONG(&_0, limit);
	ZEPHIR_CALL_FUNCTION(&_1, "abs", &_2, 181, &_0);
	zephir_check_call_status();
	...
	if (zephir_is_numeric(offset)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$4, "abs", &_2, 181, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, getPhql) {
	...
	if (Z_TYPE_P(&models) == IS_ARRAY) {
		if (!(zephir_fast_count_int(&models TSRMLS_CC))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "At least one model is required to build the query", "phalcon/mvc/model/query/builder.zep", 1047);
			return;
		}
	} else {
		if (!(zephir_is_true(&models))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "At least one model is required to build the query", "phalcon/mvc/model/query/builder.zep", 1051);
			return;
		}
	}
	ZEPHIR_OBS_VAR(&conditions);
	...
	if (zephir_is_numeric(&conditions)) {
		if (Z_TYPE_P(&models) == IS_ARRAY) {
			if (zephir_fast_count_int(&models TSRMLS_CC) > 1) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Cannot build the query. Invalid condition", "phalcon/mvc/model/query/builder.zep", 1064);
				return;
			}
			ZEPHIR_OBS_VAR(&model);
			zephir_array_fetch_long(&model, &models, 0, PH_NOISY, "phalcon/mvc/model/query/builder.zep", 1066 TSRMLS_CC);
		} else {
			...
			if (zephir_array_isset_long_fetch(&firstPrimaryKey, &primaryKeys, 0, 0 TSRMLS_CC)) {
				...
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (!(zephir_array_isset_fetch(&attributeField, &columnMap, &firstPrimaryKey, 0 TSRMLS_CC))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_5$$17, "phalcon/mvc/model/query/builder.zep", 1094 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				ZEPHIR_CALL_METHOD(&_7$$13, this_ptr, "autoescape", &_8, 302, &model);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_9$$13, this_ptr, "autoescape", &_8, 302, &attributeField);
				zephir_check_call_status();
		...
		if (noPrimary == 1) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Source related to this model does not have a primary key defined", "phalcon/mvc/model/query/builder.zep", 1109);
			return;
		}
	}
	ZEPHIR_OBS_VAR(&distinct);
	...
	if (Z_TYPE_P(&columns) != IS_NULL) {
		if (Z_TYPE_P(&columns) == IS_ARRAY) {
			...
			zephir_is_iterable(&columns, 0, "phalcon/mvc/model/query/builder.zep", 1141);
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columns), _13$$25, _14$$25, _12$$25)
			{
				...
				if (Z_TYPE_P(&columnAlias) == IS_LONG) {
					zephir_array_append(&selectedColumns, &column, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 1135);
				} else {
					ZEPHIR_CALL_METHOD(&_15$$28, this_ptr, "autoescape", &_8, 302, &columnAlias);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_16$$28);
					ZEPHIR_CONCAT_VSV(&_16$$28, &column, " AS ", &_15$$28);
					zephir_array_append(&selectedColumns, &_16$$28, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 1137);
				}
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&column);
			ZEPHIR_INIT_NVAR(&columnAlias);
		...
		if (Z_TYPE_P(&models) == IS_ARRAY) {
			...
			array_init(&selectedColumns);
			zephir_is_iterable(&models, 0, "phalcon/mvc/model/query/builder.zep", 1164);
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&models), _19$$31, _20$$31, _18$$31)
			{
				...
				if (Z_TYPE_P(&modelColumnAlias) == IS_LONG) {
					ZEPHIR_CALL_METHOD(&_21$$33, this_ptr, "autoescape", &_8, 302, &model);
					zephir_check_call_status();
					ZEPHIR_CONCAT_VS(&selectedColumn, &_21$$33, ".*");
				} else {
					ZEPHIR_CALL_METHOD(&_22$$34, this_ptr, "autoescape", &_8, 302, &modelColumnAlias);
					zephir_check_call_status();
					ZEPHIR_CONCAT_VS(&selectedColumn, &_22$$34, ".*");
				}
				zephir_array_append(&selectedColumns, &selectedColumn, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 1161);
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&model);
			ZEPHIR_INIT_NVAR(&modelColumnAlias);
			...
			ZEPHIR_CALL_METHOD(&_24$$35, this_ptr, "autoescape", &_8, 302, &models);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&models) == IS_ARRAY) {
		...
		zephir_is_iterable(&models, 0, "phalcon/mvc/model/query/builder.zep", 1187);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&models), _27$$36, _28$$36, _26$$36)
		{
			...
			if (Z_TYPE_P(&modelAlias) == IS_STRING) {
				ZEPHIR_CALL_METHOD(&_29$$38, this_ptr, "autoescape", &_8, 302, &model);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_30$$38, this_ptr, "autoescape", &_8, 302, &modelAlias);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&selectedModel);
				ZEPHIR_CONCAT_VSV(&selectedModel, &_29$$38, " AS ", &_30$$38);
			} else {
				ZEPHIR_CALL_METHOD(&selectedModel, this_ptr, "autoescape", &_8, 302, &model);
				zephir_check_call_status();
			}
			zephir_array_append(&selectedModels, &selectedModel, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 1184);
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&model);
		ZEPHIR_INIT_NVAR(&modelAlias);
		...
		ZEPHIR_CALL_METHOD(&_33$$40, this_ptr, "autoescape", &_8, 302, &models);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&joins) == IS_ARRAY) {
		zephir_is_iterable(&joins, 0, "phalcon/mvc/model/query/builder.zep", 1244);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joins), _35$$41)
		{
			ZEPHIR_INIT_NVAR(&join);
			ZVAL_COPY(&join, _35$$41);
			ZEPHIR_OBS_NVAR(&joinModel);
			zephir_array_fetch_long(&joinModel, &join, 0, PH_NOISY, "phalcon/mvc/model/query/builder.zep", 1204 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&joinConditions);
			zephir_array_fetch_long(&joinConditions, &join, 1, PH_NOISY, "phalcon/mvc/model/query/builder.zep", 1209 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&joinAlias);
			zephir_array_fetch_long(&joinAlias, &join, 2, PH_NOISY, "phalcon/mvc/model/query/builder.zep", 1214 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&joinType);
			zephir_array_fetch_long(&joinType, &join, 3, PH_NOISY, "phalcon/mvc/model/query/builder.zep", 1219 TSRMLS_CC);
			if (zephir_is_true(&joinType)) {
				ZEPHIR_CALL_METHOD(&_36$$43, this_ptr, "autoescape", &_8, 302, &joinModel);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_37$$43);
				ZEPHIR_CONCAT_SVSV(&_37$$43, " ", &joinType, " JOIN ", &_36$$43);
				zephir_concat_self(&phql, &_37$$43 TSRMLS_CC);
			} else {
				ZEPHIR_CALL_METHOD(&_38$$44, this_ptr, "autoescape", &_8, 302, &joinModel);
				zephir_check_call_status();
			...
			if (zephir_is_true(&joinAlias)) {
				ZEPHIR_CALL_METHOD(&_40$$45, this_ptr, "autoescape", &_8, 302, &joinAlias);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(&group) != IS_NULL) {
		if (Z_TYPE_P(&group) == IS_STRING) {
			if (zephir_memnstr_str(&group, SL(","), "phalcon/mvc/model/query/builder.zep", 1259)) {
		...
		zephir_is_iterable(&group, 0, "phalcon/mvc/model/query/builder.zep", 1271);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _48$$49)
		{
			ZEPHIR_INIT_NVAR(&groupItem);
			ZVAL_COPY(&groupItem, _48$$49);
			ZEPHIR_CALL_METHOD(&_49$$52, this_ptr, "autoescape", &_8, 302, &groupItem);
			zephir_check_call_status();
			zephir_array_append(&groupItems, &_49$$52, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 1268);
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&groupItem);
	...
	if (Z_TYPE_P(&order) != IS_NULL) {
		if (Z_TYPE_P(&order) == IS_ARRAY) {
			...
			zephir_is_iterable(&order, 0, "phalcon/mvc/model/query/builder.zep", 1291);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&order), _53$$56)
			{
				ZEPHIR_INIT_NVAR(&orderItem);
				ZVAL_COPY(&orderItem, _53$$56);
				ZEPHIR_CALL_METHOD(&_54$$57, this_ptr, "autoescape", &_8, 302, &orderItem);
				zephir_check_call_status();
				zephir_array_append(&orderItems, &_54$$57, PH_SEPARATE, "phalcon/mvc/model/query/builder.zep", 1289);
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&orderItem);
	...
	if (Z_TYPE_P(&limit) != IS_NULL) {
		...
		if (Z_TYPE_P(&limit) == IS_ARRAY) {
			...
			zephir_array_fetch_string(&number, &limit, SL("number"), PH_NOISY, "phalcon/mvc/model/query/builder.zep", 1306 TSRMLS_CC);
			ZEPHIR_OBS_VAR(&offset);
		...
		if (zephir_is_numeric(&number)) {
			...
			ZVAL_LONG(&_58$$67, 10);
			ZEPHIR_CALL_FUNCTION(&_59$$67, "intval", &_60, 30, &number, &_58$$67);
			zephir_check_call_status();
			...
			if (zephir_is_numeric(&offset)) {
				...
				ZVAL_LONG(&_64$$68, 10);
				ZEPHIR_CALL_FUNCTION(&_65$$68, "intval", &_60, 30, &offset, &_64$$68);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, getQuery) {
	...
	ZEPHIR_CALL_METHOD(&phql, this_ptr, "getphql", NULL, 303);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&dependencyInjector, &_0);
	if (Z_TYPE_P(&dependencyInjector) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "A dependency injection object is required to access ORM services", "phalcon/mvc/model/query/builder.zep", 1360);
		return;
	}
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, autoescape) {
	...
	_0 = zephir_memnstr_str(&identifier, SL("["), "phalcon/mvc/model/query/builder.zep", 1395);
	if (!(_0)) {
		_0 = zephir_memnstr_str(&identifier, SL("."), "phalcon/mvc/model/query/builder.zep", 1395);
	}
	_1 = _0;
