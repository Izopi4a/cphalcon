...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_resultset_complex_ce, this_ptr, "__construct", &_0, 0, result, cache);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1), _3, _4, _2)
	{
		...
		if (ZEPHIR_IS_STRING(&type, "object")) {
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _5$$11)
			{
				...
				zephir_array_fetch(&columnValue, &row, &_6$$12, PH_NOISY, "phalcon/mvc/model/resultset/complex.zep", 155 TSRMLS_CC);
			...
			do {
				if (ZEPHIR_IS_LONG(&hydrateMode, 0)) {
					...
					if (ZEPHIR_GLOBAL(orm).late_state_binding) {
						...
						zephir_array_fetch_string(&_7$$15, &column, SL("instance"), PH_NOISY, "phalcon/mvc/model/resultset/complex.zep", 173 TSRMLS_CC);
						if (zephir_instance_of_ev(&_7$$15, phalcon_mvc_model_ce TSRMLS_CC)) {
							zephir_array_fetch_string(&_8$$16, &column, SL("instance"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/resultset/complex.zep", 174 TSRMLS_CC);
						...
						zephir_array_fetch_string(&_9$$15, &column, SL("instance"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/resultset/complex.zep", 180 TSRMLS_CC);
						...
						zephir_array_fetch_string(&_13$$18, &column, SL("instance"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/resultset/complex.zep", 188 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, toArray) {
	...
	array_init(&records);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "rewind", NULL, 69);
	zephir_check_call_status();
	while (1) {
		...
		ZEPHIR_CALL_METHOD(&current, this_ptr, "current", &_2, 304);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, serialize) {
	...
	ZEPHIR_CALL_FUNCTION(&serialized, "serialize", NULL, 59, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, unserialize) {
	...
	ZEPHIR_CALL_FUNCTION(&resultset, "unserialize", NULL, 60, &data);
	zephir_check_call_status();
