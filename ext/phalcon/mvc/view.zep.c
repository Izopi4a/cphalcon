...
PHP_METHOD(Phalcon_Mvc_View, _loadTemplateEngines) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		if (Z_TYPE_P(&registeredEngines) != IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 314, this_ptr, &dependencyInjector);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View, _engineRender) {
	...
	zend_string *_14$$3;
	zend_ulong _13$$3;
	zephir_fcall_cache_entry *_4 = NULL, *_8 = NULL, *_9 = NULL, *_11 = NULL, *_18 = NULL, *_21 = NULL, *_23 = NULL, *_26 = NULL;
	int ZEPHIR_LAST_CALL_STATUS, renderLevel = 0, cacheLevel = 0;
	zend_bool silence, mustClean, notExists = 0;
	zval viewPath, _25$$21;
	zval *engines, engines_sub, *viewPath_param = NULL, *silence_param = NULL, *mustClean_param = NULL, *cache = NULL, cache_sub, __$null, key, lifetime, viewsDir, basePath, viewsDirPath, viewOptions, cacheOptions, cachedView, viewParams, eventsManager, extension, engine, viewEnginePath, viewEnginePaths, _0, _1, *_2, _3$$3, *_12$$3, _5$$6, _6$$6, _7$$7, _10$$7, _16$$16, _17$$16, _19$$15, _20$$18, _22$$20, _24$$21;
	ZEPHIR_INIT_THIS();
	...
	zephir_check_call_status();
	zephir_is_iterable(&_1, 0, "phalcon/mvc/view.zep", 711);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
	{
		ZEPHIR_INIT_NVAR(&viewsDir);
		ZVAL_COPY(&viewsDir, _2);
		ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "_isabsolutepath", &_4, 315, &viewPath);
		zephir_check_call_status();
		...
		zephir_is_iterable(engines, 0, "phalcon/mvc/view.zep", 695);
		...
		if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
			...
			ZEPHIR_CALL_METHOD(NULL, &eventsManager, "fire", &_23, 0, &_22$$20, this_ptr, &viewEnginePath);
			zephir_check_call_status();
		}
		if (!(silence)) {
			ZEPHIR_INIT_NVAR(&_24$$21);
			object_init_ex(&_24$$21, phalcon_mvc_view_exception_ce);
			ZEPHIR_INIT_LNVAR(_25$$21);
			ZEPHIR_CONCAT_SVS(&_25$$21, "View '", &viewPath, "' was not found in any of the views directory");
			ZEPHIR_CALL_METHOD(NULL, &_24$$21, "__construct", &_26, 4, &_25$$21);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_24$$21, "phalcon/mvc/view.zep", 708 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} ZEND_HASH_FOREACH_END();
...
PHP_METHOD(Phalcon_Mvc_View, exists) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&_0, 0, "phalcon/mvc/view.zep", 755);
...
PHP_METHOD(Phalcon_Mvc_View, render) {
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "ob_get_contents", &_2, 116);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&pickView) == IS_NULL) {
		...
		zephir_array_fetch_long(&renderView, &pickView, 0, PH_NOISY, "phalcon/mvc/view.zep", 828 TSRMLS_CC);
	...
	ZEPHIR_CALL_FUNCTION(&_10, "ob_get_contents", &_2, 116);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View, getPartial) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", NULL, 227);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_View, getActiveRenderPath) {
	...
	int ZEPHIR_LAST_CALL_STATUS, viewsDirsCount = 0;
	ZEPHIR_INIT_THIS();
