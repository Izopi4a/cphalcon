...
PHP_METHOD(Phalcon_Registry, next) {
	...
	zephir_read_property(&_0, this_ptr, SL("_data"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(NULL, "next", NULL, 345, &_0);
	ZEPHIR_UNREF(&_0);
...
PHP_METHOD(Phalcon_Registry, key) {
	...
	zephir_read_property(&_0, this_ptr, SL("_data"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("key", NULL, 346, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, rewind) {
	...
	zephir_read_property(&_0, this_ptr, SL("_data"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_MAKE_REF(&_0);
	ZEPHIR_CALL_FUNCTION(NULL, "reset", NULL, 347, &_0);
	ZEPHIR_UNREF(&_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Registry, valid) {
	...
	zephir_read_property(&_0, this_ptr, SL("_data"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&_1, "key", NULL, 346, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Registry, current) {
	...
	zephir_read_property(&_0, this_ptr, SL("_data"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_RETURN_CALL_FUNCTION("current", NULL, 348, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, __set) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "offsetset", NULL, 349, &key, value);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Registry, __get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "offsetget", NULL, 350, &key);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, __isset) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "offsetexists", NULL, 351, &key);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, __unset) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "offsetunset", NULL, 352, &key);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
