...
PHP_METHOD(Phalcon_Security, getRandom) {
	...
	RETURN_MEMBER(this_ptr, "_random");
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	zval *password_param = NULL, *workFactor_param = NULL, saltBytes, _1, _0$$3, _2$$12, _3$$12, _5$$13, _7$$15, _8$$15, _9$$17, _10$$17, _11$$17, _12$$17;
	...
	do {
		if (hash == 1 || hash == 2) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 353, &password, &saltBytes);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (hash == 3 || hash == 8 || hash == 9) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 353, &password, &_8$$15);
			zephir_check_call_status();
			RETURN_MM();
		}
		ZVAL_LONG(&_9$$17, 22);
		...
		ZVAL_STRING(&_10$$17, "%02s");
		ZVAL_LONG(&_9$$17, workFactor);
		ZEPHIR_CALL_FUNCTION(&_11$$17, "sprintf", NULL, 176, &_10$$17, &_9$$17);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_12$$17);
		ZEPHIR_CONCAT_SVSVSVS(&_12$$17, "$2", &variant, "$", &_11$$17, "$", &saltBytes, "$");
		ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 353, &password, &_12$$17);
		zephir_check_call_status();
		RETURN_MM();
	} while(0);
...
PHP_METHOD(Phalcon_Security, checkHash) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "crypt", NULL, 353, &password, &passwordHash);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	RETURN_MM_MEMBER(this_ptr, "_tokenKey");
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	RETURN_MM_MEMBER(this_ptr, "_token");
...
PHP_METHOD(Phalcon_Security, computeHmac) {
	...
	ZEPHIR_CALL_FUNCTION(&hmac, "hash_hmac", NULL, 354, &algo, &data, &key, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, hasLibreSsl) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "defined", NULL, 207, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getSslVersionNumber) {
	...
	zval matches, _0, _1, _2, patch, _4, _5, _3$$4;
	ZEPHIR_INIT_THIS();
