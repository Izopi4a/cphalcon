...
PHP_METHOD(Phalcon_Session_Adapter, start) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "headers_sent", NULL, 22);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 24, &name);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter, getName) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_name", NULL, 24);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Adapter, regenerateId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_regenerate_id", NULL, 25, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Session_Adapter, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 26);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Adapter, setId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 26, &id);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter, destroy) {
	...
	zend_ulong _2$$4;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *removeData_param = NULL, _SESSION, __$true, __$false, uniqueId, key, _0$$4, *_1$$4, _4$$5;
	...
	if (removeData) {
		...
		if (!(ZEPHIR_IS_EMPTY(&uniqueId))) {
			...
			zephir_is_iterable(&_SESSION, 1, "phalcon/session/adapter.zep", 275);
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_destroy", NULL, 27);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Adapter, status) {
	...
	ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 28);
	zephir_check_call_status();
	do {
...
PHP_METHOD(Phalcon_Session_Adapter, __destruct) {
	...
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_FUNCTION(NULL, "session_write_close", NULL, 29);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("_started"), &__$true);
		} else {
