...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "min", NULL, 364, &lifetime, &_0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 266, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 267, &_3, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, 365, &_7, &_9, &_10, &_11, &_12, &_13);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_libmemcached_ce, this_ptr, "__construct", &_14, 0, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, destroy) {
	...
	zend_ulong _2;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *sessionId_param = NULL, _SESSION, id, key, _0, *_1, _4, _5, _6, _7;
	zval sessionId;
	ZEPHIR_INIT_THIS();
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_is_iterable(&_SESSION, 1, "phalcon/session/adapter/libmemcached.zep", 168);
	...
	ZEPHIR_INIT_NVAR(&key);
	ZEPHIR_INIT_VAR(&_4);
	zephir_read_property(&_5, this_ptr, SL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_6, &_5, "exists", NULL, 0, &id);
	zephir_check_call_status();
	if (zephir_is_true(&_6)) {
		zephir_read_property(&_7, this_ptr, SL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
