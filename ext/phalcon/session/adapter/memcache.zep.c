...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 266, &_5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 268, &_4, &options);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_memcache_ce, this_ptr, "__construct", &_14, 0, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, destroy) {
	...
	if (zephir_is_true(&_2)) {
		zephir_read_property(&_3, this_ptr, SL("_memcache"), PH_NOISY_CC | PH_READONLY);
