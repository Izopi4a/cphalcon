...
PHP_METHOD(Phalcon_Session_Adapter_Redis, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 269, &_3, &options);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, 365, &_6, &_8, &_9, &_10, &_11, &_12);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_redis_ce, this_ptr, "__construct", &_13, 0, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
