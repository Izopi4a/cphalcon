...
PHP_METHOD(Phalcon_Tag, setDI) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_dependencyInjector"), dependencyInjector);
...
PHP_METHOD(Phalcon_Tag, getUrlService) {
	...
	if (Z_TYPE_P(&url) != IS_OBJECT) {
		...
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_urlService"), &url);
	}
	RETURN_CCTOR(url);
...
PHP_METHOD(Phalcon_Tag, getEscaperService) {
	...
	if (Z_TYPE_P(&escaper) != IS_OBJECT) {
		...
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_escaperService"), &escaper);
	}
...
PHP_METHOD(Phalcon_Tag, setAutoescape) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_autoEscape"), &_0);
...
PHP_METHOD(Phalcon_Tag, setDefaults) {
	...
	if (_0) {
		...
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_displayValues"), &_2$$3);
	} else {
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_displayValues"), &values);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, resetInput) {
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_displayValues"), &_0);
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentTitle"), &__$null);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentAppendTitle"), &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentPrependTitle"), &_2);
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentTitleSeparator"), &__$null);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, colorField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 367, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, checkField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfieldchecked", &_0, 368, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, imageInput) {
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 367, &_1, parameters, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, setTitle) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentTitle"), &title);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, setTitleSeparator) {
	...
	zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentTitleSeparator"), &titleSeparator);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Tag, appendTitle) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_1$$3);
		array_init(&_1$$3);
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentAppendTitle"), &_1$$3);
	}
	if (Z_TYPE_P(title) == IS_ARRAY) {
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentAppendTitle"), title);
	} else {
...
PHP_METHOD(Phalcon_Tag, prependTitle) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_1$$3);
		array_init(&_1$$3);
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentPrependTitle"), &_1$$3);
	}
	if (Z_TYPE_P(title) == IS_ARRAY) {
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentPrependTitle"), title);
	} else {
...
PHP_METHOD(Phalcon_Tag, getTitle) {
	...
	if (Z_TYPE_P(&_4) == IS_NULL) {
		...
		array_init(&_5$$3);
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentAppendTitle"), &_5$$3);
	}
	...
	if (Z_TYPE_P(&_6) == IS_NULL) {
		...
		array_init(&_7$$4);
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentPrependTitle"), &_7$$4);
	}
	...
	if (!(ZEPHIR_IS_EMPTY(&documentPrependTitle))) {
		ZEPHIR_CALL_FUNCTION(&tmp$$5, "array_reverse", NULL, 369, &documentPrependTitle);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", &_2, 124, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		ZVAL_LONG(&_3$$3, 6);
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "en_US.UTF-8");
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", &_5, 370, &_3$$3, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "UTF-8");
		ZEPHIR_INIT_VAR(&_6$$3);
		ZVAL_STRING(&_6$$3, "ASCII//TRANSLIT");
		ZEPHIR_CALL_FUNCTION(&_7$$3, "iconv", NULL, 323, &_4$$3, &_6$$3, &text);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "/[\\/_|+ -]+/");
	ZEPHIR_CALL_FUNCTION(&_17, "preg_replace", &_15, 33, &_0, &separator, &friendly);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "iconv");
	ZEPHIR_CALL_FUNCTION(&_17, "extension_loaded", &_2, 124, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_17)) {
		ZVAL_LONG(&_18$$10, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", &_5, 370, &_18$$10, &locale);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Tag, setDocType) {
	...
	if (_0) {
		...
		ZVAL_LONG(&_1$$3, 5);
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentType"), &_1$$3);
	} else {
		ZEPHIR_INIT_ZVAL_NREF(_2$$4);
		ZVAL_LONG(&_2$$4, doctype);
		zephir_update_static_property_ce(phalcon_tag_ce, SL("_documentType"), &_2$$4);
	}
