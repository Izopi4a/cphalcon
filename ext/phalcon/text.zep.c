...
PHP_METHOD(Phalcon_Text, random) {
	...
	do {
		if (type == 1) {
			...
			ZVAL_STRING(&_1$$3, "z");
			ZEPHIR_CALL_FUNCTION(&_2$$3, "range", &_3, 373, &_0$$3, &_1$$3);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_0$$3);
			ZVAL_STRING(&_0$$3, "A");
			ZEPHIR_INIT_NVAR(&_1$$3);
			ZVAL_STRING(&_1$$3, "Z");
			ZEPHIR_CALL_FUNCTION(&_4$$3, "range", &_3, 373, &_0$$3, &_1$$3);
			zephir_check_call_status();
		...
		if (type == 2) {
			ZVAL_LONG(&_5$$4, 0);
			ZVAL_LONG(&_6$$4, 9);
			ZEPHIR_CALL_FUNCTION(&_7$$4, "range", &_3, 373, &_5$$4, &_6$$4);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_8$$4);
			ZVAL_STRING(&_8$$4, "a");
			ZEPHIR_INIT_VAR(&_9$$4);
			ZVAL_STRING(&_9$$4, "f");
			ZEPHIR_CALL_FUNCTION(&_10$$4, "range", &_3, 373, &_8$$4, &_9$$4);
			zephir_check_call_status();
		...
		if (type == 3) {
			ZVAL_LONG(&_11$$5, 0);
			ZVAL_LONG(&_12$$5, 9);
			ZEPHIR_CALL_FUNCTION(&pool, "range", &_3, 373, &_11$$5, &_12$$5);
			zephir_check_call_status();
			break;
		}
		if (type == 4) {
			ZVAL_LONG(&_13$$6, 1);
			ZVAL_LONG(&_14$$6, 9);
			ZEPHIR_CALL_FUNCTION(&pool, "range", &_3, 373, &_13$$6, &_14$$6);
			zephir_check_call_status();
			break;
		}
		ZVAL_LONG(&_15$$7, 0);
		ZVAL_LONG(&_16$$7, 9);
		ZEPHIR_CALL_FUNCTION(&_17$$7, "range", &_3, 373, &_15$$7, &_16$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_18$$7);
		ZVAL_STRING(&_18$$7, "a");
		ZEPHIR_INIT_VAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "z");
		ZEPHIR_CALL_FUNCTION(&_20$$7, "range", &_3, 373, &_18$$7, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_18$$7);
		ZVAL_STRING(&_18$$7, "A");
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Z");
		ZEPHIR_CALL_FUNCTION(&_21$$7, "range", &_3, 373, &_18$$7, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&pool, "array_merge", &_22, 374, &_17$$7, &_20$$7, &_21$$7);
		zephir_check_call_status();
		break;
	} while(0);
...
PHP_METHOD(Phalcon_Text, reduceSlashes) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "/");
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 33, &_0, &_1, &str);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Text, concat) {
	...
	if (ZEND_NUM_ARGS() > 3) {
		...
		ZVAL_LONG(&_4$$3, 3);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "array_slice", NULL, 324, &_3$$3, &_4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Text, dynamic) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "substr_count", &_1, 375, &text, &leftDelimiter);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "substr_count", &_1, 375, &text, &rightDelimiter);
	zephir_check_call_status();
	if (!ZEPHIR_IS_IDENTICAL(&_0, &_2)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 376, &_4$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "phalcon/text.zep", 283 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_FUNCTION(&ldS, "preg_quote", &_5, 377, &leftDelimiter);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&rdS, "preg_quote", &_5, 377, &rightDelimiter);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_7, "preg_match_all", NULL, 32, &pattern, &text, &matches, &_6);
	...
	if (Z_TYPE_P(&matches) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&matches), _8$$5)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_11$$6, "array_rand", &_12, 378, &words);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&sub, "preg_quote", &_5, 377, &_13$$6, &separator);
			zephir_check_call_status();
			ZEPHIR_INIT_LNVAR(_14$$6);
			ZEPHIR_CONCAT_SVS(&_14$$6, "/", &sub, "/");
			ZVAL_LONG(&_15$$6, 1);
			ZEPHIR_CALL_FUNCTION(&_16$$6, "preg_replace", &_17, 33, &_14$$6, &word, &text, &_15$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Text, underscore) {
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "_");
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 33, &_1, &_2, &_0);
	zephir_check_call_status();
	RETURN_MM();
