...
PHP_METHOD(Phalcon_Validation_Validator_Digit, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, message, label, replacePairs, code, _1, _2, _7, _8, _3$$4, _4$$6, _5$$7, _6$$8;
	ZEPHIR_INIT_THIS();
	...
	if (!(_0)) {
		ZEPHIR_CALL_FUNCTION(&_1, "ctype_digit", NULL, 392, &value);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, "Digit");
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 385, &_7, &field, &_8, &code);
	zephir_check_call_status();
