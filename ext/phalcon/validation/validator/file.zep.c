...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, _SERVER, _POST, _FILES, value, message, label, replacePairs, types, byteUnits, unit, maxSize, matches, bytes, mime, tmp, width, height, minResolution, maxResolution, minWidth, maxWidth, minHeight, maxHeight, fieldTypes, code, minResolutionArray, maxResolutionArray, _0, _3, _7, _10, _20, _22, _23, _36, _55, _64, _66, _1$$3, _2$$5, _11$$6, _14$$6, _16$$6, _12$$7, _13$$8, _24$$9, _27$$9, _28$$9, _25$$10, _26$$11, _31$$12, _34$$12, _35$$12, _32$$13, _33$$14, _37$$15, _39$$15, _40$$15, _41$$15, _42$$15, _43$$15, _45$$15, _46$$15, _47$$15, _48$$15, _49$$15, _38$$16, _50$$18, _53$$18, _54$$18, _51$$19, _52$$20, _56$$21, _57$$24, _58$$24, _59$$26, _62$$26, _63$$26, _60$$27, _61$$28, _67$$29, _68$$29, _69$$29, _78$$29, _70$$30, _71$$31, _73$$33, _76$$33, _77$$33, _74$$34, _75$$35, _79$$36, _80$$37, _82$$38, _85$$38, _86$$38, _83$$39, _84$$40;
	ZEPHIR_INIT_THIS();
	...
	if (_8) {
		...
		ZVAL_STRING(&_11$$6, "messageIniSize");
		...
		ZVAL_STRING(&_16$$6, "FileIniSize");
		ZEPHIR_CALL_METHOD(NULL, &_11$$6, "__construct", &_17, 385, &_14$$6, &field, &_16$$6, &code);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, validation, "appendmessage", NULL, 0, &_11$$6);
		zephir_check_call_status();
		RETURN_MM_BOOL(0);
	}
	_18 = !(zephir_array_isset_string(&value, SL("error")));
	if (!(_18)) {
		_18 = !(zephir_array_isset_string(&value, SL("tmp_name")));
	}
	_19 = _18;
	if (!(_19)) {
	...
	if (!(_21)) {
		...
		ZEPHIR_CALL_FUNCTION(&_23, "is_uploaded_file", NULL, 211, &_22);
		zephir_check_call_status();
		_21 = !zephir_is_true(&_23);
	}
	if (_21) {
		ZEPHIR_INIT_VAR(&_24$$9);
		ZVAL_STRING(&_24$$9, "messageEmpty");
		...
		ZVAL_STRING(&_28$$9, "FileEmpty");
		ZEPHIR_CALL_METHOD(NULL, &_24$$9, "__construct", &_17, 385, &_27$$9, &field, &_28$$9, &code);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, validation, "appendmessage", NULL, 0, &_24$$9);
		zephir_check_call_status();
		RETURN_MM_BOOL(0);
	}
	_29 = !(zephir_array_isset_string(&value, SL("name")));
	if (!(_29)) {
		_29 = !(zephir_array_isset_string(&value, SL("type")));
	}
	_30 = _29;
	if (!(_30)) {
		_30 = !(zephir_array_isset_string(&value, SL("size")));
	}
	if (_30) {
		ZEPHIR_INIT_VAR(&_31$$12);
		ZVAL_STRING(&_31$$12, "messageValid");
		...
		ZVAL_STRING(&_35$$12, "FileValid");
		ZEPHIR_CALL_METHOD(NULL, &_31$$12, "__construct", &_17, 385, &_34$$12, &field, &_35$$12, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_36)) {
		...
		ZEPHIR_CALL_FUNCTION(&_43$$15, "floatval", &_44, 253, &_42$$15);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_43$$15, "floatval", &_44, 253, &_48$$15);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_49$$15, "floatval", &_44, 253, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_43$$15, &_49$$15)) {
			ZEPHIR_INIT_VAR(&_50$$18);
			ZVAL_STRING(&_50$$18, "messageSize");
			...
			ZVAL_STRING(&_54$$18, "FileSize");
			ZEPHIR_CALL_METHOD(NULL, &_50$$18, "__construct", &_17, 385, &_53$$18, &field, &_54$$18, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_55)) {
		...
		ZVAL_STRING(&_56$$21, "allowedTypes");
		...
		if ((zephir_function_exists_ex(SL("finfo_open") TSRMLS_CC) == SUCCESS)) {
			ZVAL_LONG(&_57$$24, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 208, &_57$$24);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 209, &tmp, &_58$$24);
			zephir_check_call_status();
		...
		if (!(zephir_fast_in_array(&mime, &types TSRMLS_CC))) {
			...
			ZVAL_STRING(&_59$$26, "messageType");
			...
			ZVAL_STRING(&_63$$26, "FileType");
			ZEPHIR_CALL_METHOD(NULL, &_59$$26, "__construct", &_17, 385, &_62$$26, &field, &_63$$26, &code);
			zephir_check_call_status();
	...
	if (_65) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 219, &_67$$29);
		zephir_check_call_status();
		...
		if (_72$$29) {
			...
			ZVAL_STRING(&_73$$33, "messageMinResolution");
			...
			if (ZEPHIR_IS_EMPTY(&message)) {
				...
				ZVAL_STRING(&_75$$35, "FileMinResolution");
			...
			ZVAL_STRING(&_77$$33, "FileMinResolution");
			ZEPHIR_CALL_METHOD(NULL, &_73$$33, "__construct", &_17, 385, &_76$$33, &field, &_77$$33, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_78$$29)) {
			...
			if (_81$$36) {
				...
				ZVAL_STRING(&_82$$38, "messageMaxResolution");
				...
				if (ZEPHIR_IS_EMPTY(&message)) {
					...
					ZVAL_STRING(&_84$$40, "FileMaxResolution");
				...
				ZVAL_STRING(&_86$$38, "FileMaxResolution");
				ZEPHIR_CALL_METHOD(NULL, &_82$$38, "__construct", &_17, 385, &_85$$38, &field, &_86$$38, &code);
				zephir_check_call_status();
