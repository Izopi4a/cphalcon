...
PHP_METHOD(Phalcon_Validation_Validator_InclusionIn, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, domain, message, label, replacePairs, strict, fieldDomain, code, _0, _1, _4, _2$$6, _3$$7, _5$$9, _10$$9, _11$$9, _6$$10, _7$$12, _8$$13, _9$$14;
	ZEPHIR_INIT_THIS();
	...
	ZEPHIR_CALL_FUNCTION(&_4, "in_array", NULL, 310, &value, &domain, &strict);
	zephir_check_call_status();
	if (!(zephir_is_true(&_4))) {
		ZEPHIR_INIT_VAR(&_5$$9);
		ZVAL_STRING(&_5$$9, "label");
		...
		ZVAL_STRING(&_11$$9, "InclusionIn");
		ZEPHIR_CALL_METHOD(NULL, &_5$$9, "__construct", NULL, 385, &_10$$9, &field, &_11$$9, &code);
		zephir_check_call_status();
