...
PHP_METHOD(Phalcon_Validation_Validator_PresenceOf, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, message, label, replacePairs, code, _1$$3, _6$$3, _7$$3, _2$$4, _3$$6, _4$$7, _5$$8;
	ZEPHIR_INIT_THIS();
