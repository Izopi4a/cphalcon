...
PHP_METHOD(Phalcon_Validation_Validator_Regex, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, matches, message, value, label, replacePairs, code, pattern, _0, _1$$3, _2$$4, _3$$6, _8$$6, _9$$6, _4$$7, _5$$9, _6$$10, _7$$11;
	ZEPHIR_INIT_THIS();
	...
	if (failed == 1) {
		...
		ZVAL_STRING(&_9$$6, "Regex");
		ZEPHIR_CALL_METHOD(NULL, &_3$$6, "__construct", NULL, 385, &_8$$6, &field, &_9$$6, &code);
		zephir_check_call_status();
